...
import BoundsEnhancer from "./BoundsEnhancer";
...
export default BoundsEnhancer(ConfigEnhancer(DataEnhancer(ScrollEnhancer(HighlightEnhancer(ScaleEnhancer(MoveEnhancer(LineChart)))))))
